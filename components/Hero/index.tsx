...
const Hero = () => {
  ...
  const getTips = async () => {
    const url = `https://payloadx.getintellisoft.com/api/v1/futnance/node/getdata?node=Matches`;
        const options = {
            method: 'GET',
            headers: {
                'client': 'futnance',
  ...
  return (
    <>
      ...
      >
        <div className="container-fluid  pt-[120px] pb-6 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]" style={{backgroundColor: "#496bf680", width: "100% !important", padding: 30}}>
          ...
          {
             tips.slice(0, 4).map((a, index) => {
              
                a.title = `${a.homeTeam} VS ${a.awayTeam}`;
                a.paragraph = `${a.league} | ${a.prediction}`;
                
                  return (
                    <SingleFeature key={index} feature={a} />                    
                  )

...
const countriesPayment: Feature[] = [
    {
        id: 1,
        icon: (
        ...
        title: "How to pay (general)",
        paragraph:
            "We give accurate tips with high odds for good return on your stake",
    ...
    },
    {
        ...
        title: "90%+ Accuracy",
        paragraph:
            "You can always count on our predictions. Our prediction are analysed by experts in the game",
    },
    {
        id: 3,
        icon: (
        ...
        title: "Over 5 Sports",
        paragraph:
            "Our prediction cut accross football, basketball, tennis and others to give you chance to explore diverse options",
    }
];
export default countriesPayment;
